...
CREATE TABLE fdata (
    ...
    nutrient_100_energy float DEFAULT 0,
    nutrient_100_fat_total float DEFAULT 0,
    nutrient_100_fat_saturated float DEFAULT 0,
    nutrient_100_protein float DEFAULT 0,
    nutrient_100_fibers float DEFAULT 0,
    nutrient_100_calcium float DEFAULT 0,
    nutrient_100_carb float DEFAULT 0,
    nutrient_100_sugar float DEFAULT 0,
    nutrient_100_salt float DEFAULT 0,
    nutrient_100_lactose float DEFAULT 0,
    nutrient_100_natrium float DEFAULT 0,
    nutrient_100_bread_unit float DEFAULT 0,

    nutrient_snd_amount integer DEFAULT 0,
    nutrient_snd_additional varchar(255) DEFAULT '',

    nutrient_snd_energy float DEFAULT 0,
    nutrient_snd_fat_total float DEFAULT 0,
    nutrient_snd_fat_saturated float DEFAULT 0,
    nutrient_snd_protein float DEFAULT 0,
    nutrient_snd_fibers float DEFAULT 0,
    nutrient_snd_calcium float DEFAULT 0,
    nutrient_snd_carb float DEFAULT 0,
    nutrient_snd_sugar float DEFAULT 0,
    nutrient_snd_salt float DEFAULT 0,
    nutrient_snd_lactose float DEFAULT 0,
    nutrient_snd_natrium float DEFAULT 0,
    nutrient_snd_bread_unit float DEFAULT 0,
