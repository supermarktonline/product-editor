...
$in_segment = $db->prepare("INSERT INTO category SET segment_description_en=:segment_description_en WHERE segment_code=:segment_code");
$in_family = $db->prepare("INSERT INTO category SET family_description_en=:family_description_en WHERE family_code=:family_code");
$in_class = $db->prepare("INSERT INTO category SET class_description_en=:class_description_en WHERE class_code=:class_code");
$in_brick = $db->prepare("INSERT INTO category SET brick_description_en=:brick_description_en,brick_definition_en=:brick_definition_en WHERE brick_code=:brick_code");
$in_attribute = $db->prepare("INSERT INTO taggroup SET muid=:muid,definition_en=:definition_en WHERE gs1_attribute_type_code=:gs1_attribute_type_code");
$in_value = $db->prepare("INSERT INTO tag SET muid=:muid,definition_en=:definition_en WHERE gs1_attribute_value_code=:gs1_attribute_value_code");
